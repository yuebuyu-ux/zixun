...
4.  从候选条目筛选 **12-15条**（优先凑15条，不足则按实际数量输出），每条必须包含3个字段，字段填写严格遵守以下规范：
    - "title"：精炼短句标题，≤22字，不用提问句式，直接陈述核心事件，突出爆点；
    - "summary_short"：一句话看点，20-30字，必须拆成2个短分句用「；」连接，**严禁复述title内容**，只提炼用户关心的“爽点/笑点/争议点”；
    - "summary_long"：资深娱乐记者口吻的事件讲解+点评，90-120字，信息密度高，必须说清「事件为什么火/核心看点在哪/背后的趣味逻辑」，语言轻松吐槽，不堆砌专业术语；
5.  提取 1 句「吃瓜哲学」金句作为 "tip"：不带作者，口语化接地气，适配睡前吃瓜氛围，有共鸣感；禁止写鸡汤式大道理
