...
def build_parser():
    ...
    p_run.add_argument("--douyin-url", default="")
    p_run.add_argument("--no-manual-video", action="store_true", default=False)
    ...
    p_run.add_argument("--max-page-chars", type=int, default=12000)
